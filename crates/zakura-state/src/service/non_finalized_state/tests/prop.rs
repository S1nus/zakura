...
fn push_genesis_chain() -> Result<()> {
    ...
    |((chain, count, network, empty_tree) in PreparedChain::default())| {
        ...
        let mut only_chain = Chain::new(&network, Height(0), Default::default(), Default::default(), Default::default(), Default::default(), Default::default(), empty_tree, ValueBalance::zero());
...
fn push_history_tree_chain() -> Result<()> {
    ...
    |((chain, count, network, finalized_tree) in PreparedChain::new_heartwood())| {
        ...
        let mut only_chain = Chain::new(&network, Height(0), Default::default(), Default::default(), Default::default(), Default::default(), Default::default(), finalized_tree, ValueBalance::zero());
...
fn forked_equals_pushed_history_tree() -> Result<()> {
    ...
    |((chain, fork_at_count, network, finalized_tree) in PreparedChain::new_heartwood())| {
        ...
        let mut full_chain = Chain::new(&network, Height(0), Default::default(), Default::default(), Default::default(), Default::default(), Default::default(), finalized_tree.clone(), ValueBalance::zero());
        let mut partial_chain = Chain::new(&network, Height(0), Default::default(), Default::default(), Default::default(), Default::default(), Default::default(), finalized_tree, ValueBalance::zero());
...
fn finalized_equals_pushed_genesis() -> Result<()> {
    ...
    |((chain, end_count, network, empty_tree) in PreparedChain::default())| {
        ...
        let mut full_chain = Chain::new(&network, Height(0), Default::default(), Default::default(), Default::default(), Default::default(), Default::default(), empty_tree, fake_value_pool);
        for block in chain
            .clone()
...
fn finalized_equals_pushed_history_tree() -> Result<()> {
    ...
    |((chain, end_count, network, finalized_tree) in PreparedChain::new_heartwood())| {
        ...
        let mut full_chain = Chain::new(&network, Height(0), Default::default(), Default::default(), Default::default(), Default::default(), Default::default(), finalized_tree, fake_value_pool);
        for block in chain
            .iter()
            .take(finalized_count)
            .map(ContextuallyVerifiedBlock::test_with_zero_spent_utxos) {
...
fn different_blocks_different_chains() -> Result<()> {
    ...
    |((vec1, vec2) in (any::<bool>(), any::<bool>())
      ...
      .prop_flat_map(|block_strategy| (block_strategy.clone(), block_strategy))
        ...
        let chain1 = Chain::new(&Network::Mainnet, Height(0), Default::default(), Default::default(), Default::default(), Default::default(), Default::default(), finalized_tree1, ValueBalance::fake_populated_pool());
        let chain2 = Chain::new(&Network::Mainnet, Height(0), Default::default(), Default::default(), Default::default(), Default::default(), Default::default(), finalized_tree2, ValueBalance::fake_populated_pool());
